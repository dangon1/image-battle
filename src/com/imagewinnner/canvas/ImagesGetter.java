...
//		"https://i.pinimg.com/564x/4a/7c/5a/4a7c5a63fe4d2a6c7f8d140c0d2b45b1.jpg",
	...
	public static Stack<SimpleEntry<String,BufferedImage>> getImages() throws IOException {
		Stack<SimpleEntry<String,BufferedImage>> imagesStack = new Stack<>();
		SimpleEntry<String,BufferedImage> simpleEntry;
		for (String imageURL : imagesURL) {
	        System.out.println("Getting Image from " + imageURL);
	        URL url = new URL(imageURL);
	        simpleEntry = new AbstractMap.SimpleEntry<>(imageURL,ImageIO.read(url));
	        imagesStack.push(simpleEntry);
		}
